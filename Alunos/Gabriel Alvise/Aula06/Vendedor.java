...
public class Vendedor {
    ...
    public Vendedor(String nome, int idade, String loja, String cidade, String bairro, String rua, double salarioBase, ArrayList<Double> salarios) {
        this.nome = nome;
        this.idade = idade;
        this.loja = loja;
        this.cidade = cidade;
    ...
    public void calcularMedia() {
        ...
        System.out.printf("Média de salários do vendedor %s: R$ %.2f\n", getNome(), mediaSalarios);

    }

    public void calcularBonus() {
        double bonus = salarioBase * 0.2;
        double salarioBonus = salarioBase + bonus;
        System.out.printf("Vendedor: %s | Salário Base: %.2f | Bônus: %.2f| Salário Com Bônus: %.2f\n", nome, salarioBase, bonus, salarioBonus);
    }
