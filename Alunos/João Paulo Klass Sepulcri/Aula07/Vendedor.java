public class Vendedor extends Pessoa {
    ...
    public Vendedor(String nome, int idade, Endereco endereco, Loja loja, double salarioBase, double[] salarioRecebido) {
    ...
    public Vendedor(String nome, int idade, Loja loja, String cidade, String bairro, String rua, double salarioBase, double[] salarioRecebido) {
        this(nome, idade, new Endereco("PR", cidade, bairro, "S/N", rua), loja, salarioBase, salarioRecebido);
    }
